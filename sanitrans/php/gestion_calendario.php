...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    header("Location: gestion_calendario.php"); // Recargar la página
    exit();
}
                    ...
                    <tbody>
                        <?php foreach ($turnos as $turno): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="gestion_calendario.php?editar=<?php echo $turno['id']; ?>&empleado_id=<?php echo $turno['empleado_id']; ?>&fecha=<?php echo $turno['fecha']; ?>&hora_inicio=<?php echo $turno['hora_inicio']; ?>&hora_fin=<?php echo $turno['hora_fin']; ?>&descripcion=<?php echo urlencode($turno['descripcion']); ?>"
                                        class="btn btn-warning btn-sm">Editar</a>
                                    <a href="gestion_calendario.php?eliminar=<?php echo $turno['id']; ?>"
