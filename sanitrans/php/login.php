...
<body class="d-flex justify-content-center align-items-center vh-100 flex-column">
    ...
    <header class="container h-25 mb-5 mw-100 p-3">
        <h1 class="m-2">Plataforma web transporte sanitario</h1>
       <!-- <img src="/sanitrans/img/ambulancia.png" alt="Logo Ambulancia" width="200" height="141"/> -->
    </header>

    <div class="login card m-2 p-4">
        ...
        <form method="POST">
            ...
            <button type="submit" class="btn btn-primary w-100" style="background-color:#24809F">Entrar</button>
        </form>
    </div>
</body>
