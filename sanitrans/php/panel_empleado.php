...
// Verificar si hay un error de turno no activo
$error_turno_No_activo = isset($_GET['error']) && $_GET['error'] === 'turno_No_activo';
...
$error_inicio_turno = isset($_GET['error']) && $_GET['error'] === 'error_inicio_turno';
...
<body>
    ...
    <div class="container mt-5">
        ...
        <?php if (isset($_GET['parte_registrado'])): ?>
            <div class="alert alert-success">Registro correcto!!</div>
        <?php endif; ?>

        <?php if ($error_turno_No_activo): ?>
            <div class="alert alert-warning">
                No tienes aún turno activo. Selecciona matricula para iniciar turno.
            </div>
        <?php endif; ?>

        <?php if ($error_inicio_turno): ?>
            <div class="alert alert-warning">
                Error!!. Los kilómetros son inferiores a los registrados anteriormente
            </div>
        <?php endif; ?>
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <!-- Botón para ver el registro de combustible -->
                ...
                <!-- Botón para ver el registro de incidencias -->
                ...
                <!-- Botón para ver el checklist si no se ha realizado aun y hay un turno activo-->
                ...
                <!-- Botón para ver el parte de asistencia si hay un turno activo-->
                <?php if ($turno_activo): ?>
